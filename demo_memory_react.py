...
def demo_basic_memory_react():
    ...
    print(f"   - Research Findings: {result1['memory_summary']['total_research_findings']}")
    ...
    result2 = agent.forward(
        goal="Research popular AI agent frameworks and tools",
        max_iterations=3
    )
    
    print(f"\n📊 Memory Summary after Goal 2:")
    print(f"   - Search Results: {result2['memory_summary']['total_search_results']}")
    print(f"   - Research Findings: {result2['memory_summary']['total_research_findings']}")
    ...
    print(f"   - Research Findings: {result3['memory_summary']['total_research_findings']}")
...
def demo_article_agent_with_memory():
    ...
    print(f"   - Research Findings: {result['memory_summary']['total_research_findings']}")
...
def demo_memory_persistence():
    ...
    result1 = agent1.forward(
        goal="Research Python frameworks for AI agents",
        max_iterations=2
    )
    ...
    result2 = agent1.forward(
        goal="Research JavaScript frameworks for AI agents",
        max_iterations=2
    )
...
def main():
    ...
    print("This demo shows how the ReACT agent can maintain context and search sources across iterations.")
